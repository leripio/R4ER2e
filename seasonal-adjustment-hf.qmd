...
Additionally, other features — such as trend changepoints — may also play a role. To explore the full range of features available in Prophet and gain a deeper understanding of how to fine-tune its default parameters, I strongly recommend consulting the package’s [documentation](https://facebook.github.io/prophet/docs/quick_start.html#r-api).
