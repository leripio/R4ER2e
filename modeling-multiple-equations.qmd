...
model_fit_tidy <- do.call(ts.union, model_fit$modelData) |>
  timetk::tk_tbl() |> 
...
#| warning: false
#| message: false
output_observed <- do.call(ts.intersect, model_fit$modelData) |> 
  timetk::tk_tbl(rename_index = 'date') |> 
  mutate(type = 'Observed') 

output_forecast <- do.call(ts.intersect, model_sim$simulation[1:3]) |> 
  timetk::tk_tbl(rename_index = 'date') |> 
